...
//                 <Form.Control type="text" placeholder="请输入商品标题"/>
//             </Form.Group>
...
// const CommodityButton = (props)=>{
//     const {loadCommodities} = props
...
//             await formData.append('pictures',document.querySelector('#uploader').files[0])//表示获取第一个文件，即刚刚上传的头像
...
//     const handlePost = ()=>{  
//         const form = document.forms.commodityForm
//         const title = form.title.value //value表示用户输入的值
//         const content = form.content.value
//         const category = form.category.value
//         const price = form.price.value
//         const body = {title,content,category,price}//用body将三个变量封装到body里，相当于请求体
//         post(body)
//     }
//     return(
//         <div>
