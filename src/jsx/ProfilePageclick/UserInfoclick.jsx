...
import PostletterButton from './PostletterButton'
...
const UserInfoclick = (props)=>{
    ...
    return(
        <div>
                <ProfileInfo user={user} followers={followers} followers2={followers2} fans={fans} wallpaper={wallpaper}/>
                {auth?
                (  
                <div style={{textAlign:"center"}}>
                <Followers uid={uid} getUser={getUser}/>|<PostletterButton uid={uid}/>
                </div>
                )
                :
                null}
